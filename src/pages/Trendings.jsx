...
const Trendings = ({ isAuthenticated, setRedirectTo }) => {
    ...
    const location = useLocation();
      ...
      async function getTicketsList() {
        ...
        try {
            ...
            setDeals(result?.data?.data?.trending_tickets?.data)
    ...
    <div className='ticket-listing-wrapper'>
       ...
       {loading && <div className='main-loader'>
            ...
            <div className="container">
              <h2 className="title-main mb-4">Most Trendings Deals</h2>
            <div className="row">
            {deals?.map((ticket,index)=>  <div className="col-12 col-md-6 col-lg-4 mb-4" key={index}>
